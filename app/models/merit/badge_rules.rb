...
module Merit
  class BadgeRules
    ...
    def initialize
      ...
      # end
      grant_on 'posts#create', :badge => 'Discoverer', :temporary => false, :model_name => 'Post' do |post|
        post.user.posts.count >= 1
      end
      grant_on 'posts#create', :badge => 'Volunteer', :temporary => false, :model_name => 'Post' do |post|
